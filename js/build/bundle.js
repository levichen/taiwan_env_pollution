...
/***/ function(module, exports, __webpack_require__) {
	...
	var TaipeiMap = __webpack_require__(1);
	var MapLegend = __webpack_require__(2);
	var Details = __webpack_require__(3);
	var container;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FactoryAirPollution = __webpack_require__(5);
	...
	module.exports = React.createClass({displayName: "module.exports",
		...
		render: function() {
			return (
				React.createElement("div", {id: "map", style: this.props.style}, 
					React.createElement("svg", {width: this.props.width, height: this.props.height}, 
						React.createElement("g", {ref: "map"}), 
						React.createElement(FactoryAirPollution, {projection: this.state.projection})
					)
				)
			);
		}
		...
		render: function() {
			...
			return (
				React.createElement("div", {style: this.props.style}, 
					React.createElement("svg", {ref: "maplegend", height: height, width: width})
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var React = __webpack_require__(4);
	var d3 = __webpack_require__(7);
	var BrokenLineChart = __webpack_require__(6);
	...
	module.exports = React.createClass({displayName: "module.exports",
		...
		render: function() {
			...
			for (var i = 0; i < this.state.data.length; i++) {
				items.push(React.createElement(BrokenLineChart, {titleWidth: 90, digramWidth: 120, height: digramHeight, 
					title: this.state.data[i].name, data: this.state.data[i].data}));
			}

			return (
				React.createElement("div", {style: this.props.style, ref: "details"}, 
					React.createElement("div", {id: "detail-head"}, 
						React.createElement("div", {id: "detail-name", style: nameStyle}, "Name"), 
						React.createElement("div", {id: "detail-digram", style: digramStyle}, "Digram")
					), 
					React.createElement("div", {style: {marginTop: '20px'}}, items)
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */module.exports = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
		...
		render: function() {
			return (
				React.createElement("g", {ref: "layer"})
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
		...
		render: function() {
			return (
				React.createElement("div", {style: {margin: '10px 0 10px 0'}}, 
					React.createElement("svg", {ref: "factory_air_pollution", width: this.props.titleWidth + this.props.digramWidth, height: this.props.height})
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;/** @jsx React.DOM */!function() {
	  var d3 = {
	    version: "3.5.5"
	  };
